...
<table cellpadding="0" cellspacing="0" border="0" class="form_table" width="100%">
	<tr>
		<td valign="middle" align="right" width="15%">姓名:</td>
		<td valign="middle" align="left">
			<input type="text" class="k-textbox" name="name" id="name" style="width:60%" />
		</td>
	</tr>
	<tr>
		<td valign="middle" align="right">薪水:</td>
		<td valign="middle" align="left">
			<input type="text" class="k-textbox" name="salary" id="salary" style="width:60%" />
		</td>
	</tr>
	<tr>
		<td valign="middle" align="right">年龄:</td>
		<td valign="middle" align="left">
			<input type="text" class="k-textbox" name="age" id="age" style="width:60%" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="middle" align="left">
			<input type="text" class="k-textbox" name="email" id="email" style="width:60%"/>
		</td>
	</tr>	
	<tr>
		<td>学历及经历：</td>
		<td>
			<textarea name="details" id="editor" rows="10" cols="30" style="height:440px" aria-label="editor"></textarea>
		</td>
	</tr>												
</table>
